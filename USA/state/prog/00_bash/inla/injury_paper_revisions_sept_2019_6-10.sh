...
Rscript ~/git/mortality/USA/state/prog/models/INLA/03_spatiotemporal/inla_spatiotemporal_climate_cod_era5.R 45 1 $start $end 28 0 $dname $metric $start2 $end2 $cod $fast $contig $pw;
