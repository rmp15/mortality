...
load.function = function(model.sel){
    ...
    if(pw.arg==0){
        if(contig==1){
            if(cause!='AllCause'){
                dat <- readRDS(paste0('../../data/climate_effects_era5/',dname,'/',metric,'/non_pw/type_',model,'/parameters/',
    ...
    if(pw.arg==1){
        if(contig==1){
            if(cause!='AllCause'){
                dat <- readRDS(paste0('../../data/climate_effects_era5/',dname,'/',metric,'/pw/type_',model,'/parameters/',
                country,'_rate_pred_type',model,'_',year.start,'_',year.end,'_',dname,'_',metric,'_',cause,'_fast_contig'))
            }
            if(cause=='AllCause'){
                dat <- readRDS(paste0('../../data/climate_effects_era5/',dname,'/',metric,'/pw/type_',model,'/parameters/'
...
if(pw.arg==0){
    file.loc <- paste0('../../output/mapping_posterior_climate_era5/',year.start,'_',year.end,
