...
# change factors of age group to match summarised mortality data
#pop.state$age <- as.factor(pop.state$age)
#levels(pop.state$age) <- 
#c('0','5','5','15','15','25','25','35','35','45','45','55','55','65','65','75','75','85')
...
# construct a curve, where pop.n = pop.0*exp(alpha*n) n=0,1...12
# pop.0  = pop
# pop.12 = pop.shifted

pop.state.exp <- pop.state

pop.state.exp$alpha <- (1/12) * log(pop.state$pop.shifted/pop.state$pop)

pop.state.exp$jan <- pop.state.exp$pop*exp(0*pop.state.exp$alpha)
pop.state.exp$feb <- pop.state.exp$pop*exp(1*pop.state.exp$alpha)
pop.state.exp$mar <- pop.state.exp$pop*exp(2*pop.state.exp$alpha)
pop.state.exp$apr <- pop.state.exp$pop*exp(3*pop.state.exp$alpha)
pop.state.exp$may <- pop.state.exp$pop*exp(4*pop.state.exp$alpha)
pop.state.exp$jun <- pop.state.exp$pop*exp(5*pop.state.exp$alpha)
pop.state.exp$jul <- pop.state.exp$pop*exp(6*pop.state.exp$alpha)
pop.state.exp$aug <- pop.state.exp$pop*exp(7*pop.state.exp$alpha)
pop.state.exp$sep <- pop.state.exp$pop*exp(8*pop.state.exp$alpha)
pop.state.exp$oct <- pop.state.exp$pop*exp(9*pop.state.exp$alpha)
pop.state.exp$nov <- pop.state.exp$pop*exp(10*pop.state.exp$alpha)
pop.state.exp$dec <- pop.state.exp$pop*exp(11*pop.state.exp$alpha)

library(tidyr)
# convert to long-form table for lookup
pop.state.exp.long <- pop.state.exp %>% gather(month.exp, pop.adj.exp, jan:dec)

pop.state.exp.long$month.exp[pop.state.exp.long$month.exp=='jan'] <- 1
pop.state.exp.long$month.exp[pop.state.exp.long$month.exp=='feb'] <- 2
pop.state.exp.long$month.exp[pop.state.exp.long$month.exp=='mar'] <- 3
pop.state.exp.long$month.exp[pop.state.exp.long$month.exp=='apr'] <- 4
pop.state.exp.long$month.exp[pop.state.exp.long$month.exp=='may'] <- 5
pop.state.exp.long$month.exp[pop.state.exp.long$month.exp=='jun'] <- 6
pop.state.exp.long$month.exp[pop.state.exp.long$month.exp=='jul'] <- 7
pop.state.exp.long$month.exp[pop.state.exp.long$month.exp=='aug'] <- 8
pop.state.exp.long$month.exp[pop.state.exp.long$month.exp=='sep'] <- 9
pop.state.exp.long$month.exp[pop.state.exp.long$month.exp=='oct'] <- 10
pop.state.exp.long$month.exp[pop.state.exp.long$month.exp=='nov'] <- 11
pop.state.exp.long$month.exp[pop.state.exp.long$month.exp=='dec'] <- 12

pop.state.exp.long$month.exp <- as.integer(pop.state.exp.long$month.exp)
...
pop.state.lin.long$month.lin[pop.state.lin.long$month.lin=='jan'] <- 1
pop.state.lin.long$month.lin[pop.state.lin.long$month.lin=='feb'] <- 2
pop.state.lin.long$month.lin[pop.state.lin.long$month.lin=='mar'] <- 3
pop.state.lin.long$month.lin[pop.state.lin.long$month.lin=='apr'] <- 4
pop.state.lin.long$month.lin[pop.state.lin.long$month.lin=='may'] <- 5
pop.state.lin.long$month.lin[pop.state.lin.long$month.lin=='jun'] <- 6
pop.state.lin.long$month.lin[pop.state.lin.long$month.lin=='jul'] <- 7
pop.state.lin.long$month.lin[pop.state.lin.long$month.lin=='aug'] <- 8
pop.state.lin.long$month.lin[pop.state.lin.long$month.lin=='sep'] <- 9
pop.state.lin.long$month.lin[pop.state.lin.long$month.lin=='oct'] <- 10
pop.state.lin.long$month.lin[pop.state.lin.long$month.lin=='nov'] <- 11
pop.state.lin.long$month.lin[pop.state.lin.long$month.lin=='dec'] <- 12

pop.state.lin.long$month.lin <- as.integer(pop.state.lin.long$month.lin)
...
saveRDS(pop.state.long, 'statePopulations_infer')
