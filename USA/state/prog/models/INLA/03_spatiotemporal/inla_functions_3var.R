...
inla.function.climate.3var <- function(age.sel,sex.sel,year.start,year.end,type,cluster) {
...
inla.function.climate.3var.fast <- function(age.sel,sex.sel,year.start,year.end,type,cluster) {
...
inla.function.climate.3var.faster <- function(age.sel,sex.sel,year.start,year.end,type,cluster) {
