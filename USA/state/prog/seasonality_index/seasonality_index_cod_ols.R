...
# file.loc.nat.input <- paste0("../../output/com/",year.start,'_2013',"/national/values/combined_results/")
# dat.COM <- readRDS(paste0(file.loc.nat.input,'com_inv_com_rates_national_values_method_2_entire_',cod,'_',year.start,'_2013'))
#
...
# model suggested by eLife is like the following
# --------------------- -------------------------------------
# Yit∼ Poisson(Nit ⋅ λit)
